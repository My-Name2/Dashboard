...
If Streamlit Cloud is blocked by Macrotrends, run the proxy from a machine/network where Macrotrends works and expose it with a tunnel or private endpoint you control.
