...
def macrotrends_client_name() -> str:
    return "curl_cffi Chrome impersonation" if curl_requests is not None else "plain requests fallback"


def macrotrends_was_blocked() -> bool:
    return any("403 for https://www.macrotrends.net" in line for line in st.session_state.logs)
